...
const calendarImage = require('../assets/img/4539158470d59c9662bc64f5b6801e6fecd34c84.png');
            ...
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.content}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        {/*    resizeMode='stretch'*/}
                        {/*/>*/}
                        <Text style={styles.mainTitle}>All progress - in the calendar</Text>
                        <Text style={styles.description}>
                            Track what you did every day:
                            exercises, time, volcanoes, points.
                            Reminders will help you not to stop.
                        </Text>
                    </View>
                </View>

                <TouchableOpacity style={styles.button} onPress={() => {navigation.navigate('WelcomeScreen4')}}>
                    <LinearGradient
