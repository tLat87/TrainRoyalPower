...
const calendarImage = require('../assets/img/7a296c30d9d3ad44dae45969b0873972a8526524.png');
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.textContainer}>
                        <Image
                            ...
                            resizeMode='stretch'
                        />
                        <Text style={styles.mainTitle}>Customize your training</Text>
                        <Text style={styles.description}>
                            Set sets, work and rest times for strength and yoga.
                            Cardio - just press "Start" and go!                        </Text>
                    </View>
                </View>
