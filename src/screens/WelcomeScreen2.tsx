...
const calendarImage = require('../assets/img/b5f4978ab72db224afe77f6dafa20fd0128491b2.png');
            ...
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.content}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        {/*    resizeMode='stretch'*/}
                        {/*/>*/}
                        <Text style={styles.mainTitle}>Accumulate the energy of your element</Text>
                        <Text style={styles.description}>
                            Receive points for each approach:
                            💪 Strength (red)
                            ⚡️ Activity (blue)
                            🧘‍♀️ Calmness (green)
                            Charge your volcanoes - follow the progress bar!
                        </Text>
                    </View>
                </View>

                <TouchableOpacity style={styles.button} onPress={()=>{navigation.navigate('WelcomeScreen3')}}>
                    <LinearGradient
